...
class MenuScreen(Screen):
    def __init__(self, **kwargs):
        ...
        back_button = Button(text="",
                      font_size=7,
                      background_normal="TCC/py.kivy/py/img_wireframe\ICONS\Menu/perfil.png",
                      background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                      border=(0,0,0,0),
                      size_hint=(None, None),
                      size=(50, 50),
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe/Imagem1.png",
                size_hint=(None, None),
                size=(50, 50))
        ...
        layout.add_widget(top_button_layout)
          ...
          # Botão "centro"
        btn5 = Button(text="", 
                        background_normal="TCC/py.kivy/py/img_wireframe/alunos.png",
                        background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                        border=(0,0,0,0),
                        size_hint=(None, None), 
                        size=(170, 170), 
        ...
        with btn5.canvas.before:
          ...
          # Rótulo para o primeiro botão
            ...
            # Botão2 "centro"
        btn6 = Button(text="", 
                        background_normal="TCC/py.kivy/py/img_wireframe\ICONS\Menu/professor.png",
                        background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                        border=(0,0,0,0),
                        size_hint=(None, None), 
                        size=(170, 170), 
...
class LoginADMScreen(Screen):
    def __init__(self, **kwargs):
        ...
        back_button = Button(text="Voltar",
                      font_size=7,
                      background_normal="TCC/py.kivy/py/img_wireframe/voltar.png",
                      background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                      border=(0,0,0,0),
                      size_hint=(None, None),
                      size=(50, 50),
    ...
    def __init__(self, **kwargs):
       ...
       # Botão "Login" ancorado no canto superior direito
        login_button = Button(text="",
                              font_size=7,
                              background_normal="TCC/py.kivy/py/img_wireframe/login.png",
                              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(60, 60))
        ...
        Adicionar_button = Button(text="",
                              font_size=0,
                              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/adm.secretaria/segue.png",
                              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(175, 175))
        ...
        validar_button = Button(text="",
                              font_size=0,
                              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/adm.secretaria/conta-verificada.png",
                              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(175, 175))
...
class ContaADMScreen(Screen):
    def __init__(self, **kwargs):
      ...
      # Defina a cor de fundo
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Conta\Avaliacao.png",
              size_hint=(None, None),
              size=(170, 170))
    ...
    def __init__(self, **kwargs):
       ...
       # Botão "Login" ancorado no canto superior direito
        ...
        conteudo_button = Button(text="",
                              font_size=0,
                              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Aluno/escolher_atividade.png",
                              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(260, 260))
...
class ContaALUNOScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe/alunos.png",
          size_hint=(None, None),
          size=(170, 170))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=400)
        anchor_layout.add_widget(image)
...
class ProfessorScreen(Screen):
    def __init__(self, **kwargs):
       ...
       # Botão "Login" ancorado no canto superior direito
        ...
        conteudo_button = Button(text="",
                              font_size=0,
                              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Professor/Conteudo.png",
                              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
                              border=(0,0,0,0),
                              size_hint=(None, None),
                             size=(260, 260))
...
class ContaPROFScreen(Screen):
    def __init__(self, **kwargs):
        ...
        #img professor
        img_layout = BoxLayout(orientation='vertical', spacing=8, padding=(0, 0, 0, 220))  # Adicionamos margem inferior de 170
        image = Image(source="TCC/py.kivy/py/img/Jaqueline_Maciel.png",
                size_hint=(None, None),
                size=(260, 260))
...
class ConteudoScreen(Screen):
    def __init__(self, **kwargs):
        ...
        brn1 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Atividade-a/Icone.png", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
       ...
       # Botao e label "palavras cruzadas"
        brn2 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Pc-Imprimir/Pc-imagem.png", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(125, 160), #tamanho
       ...
       # Botao e label "quebra cabeça"
        brn3 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/quebra cabeca/quebra-cabeca.png", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(125, 160), 
        ...
        btn4 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Matematica/Matematica.png", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(125, 160), #tamanho
        ...
        btn5 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/ICONS/Pintura/Pinturap.png",  
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(125, 160), #tamanho
...
class QuebraCabecaScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem de fundo
        background_image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\quebra cabeca\Fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\quebra cabeca\quebra-cabeca.png",
                size_hint=(None, None),
                size=(55, 55))
        anchor_layout = AnchorLayout(anchor_x='right', anchor_y='top', size_hint_y=None, height=690)
        anchor_layout.add_widget(image)
...
class QuebraCabecaCriarScreen(Screen):
    def __init__(self, **kwargs):
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\quebra cabeca\mao.png",
                size_hint=(None, None),
                size=(260, 260))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=290)
        anchor_layout.add_widget(image)
...
class QuebraCabecaEscolherScreen(Screen):
    def __init__(self, **kwargs):
       ...
       # Botões "Escolher"
        brn1 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/meio_a_meio/meio1.jpeg", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn2 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/qc/quebra1.jpeg", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn3 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/qc/quebra2.jpeg", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), 
        ...
        btn4 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/meio_a_meio/meio2.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
...
class AtividadeAScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem de fundo
        background_image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Atividade-A\Fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Atividade-A\Icone.png",
                size_hint=(None, None),
                size=(55, 55))
        anchor_layout = AnchorLayout(anchor_x='right', anchor_y='top', size_hint_y=None, height=690)
        anchor_layout.add_widget(image)
...
class AtividadeAcriarScreen(Screen):
    def __init__(self, **kwargs):
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Atividade-A\Imagem1.png",
                size_hint=(None, None),
                size=(260, 260))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=290)
        anchor_layout.add_widget(image)
...
class MatematicaScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem de fundo
        background_image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Matematica\Fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Matematica\Matematica.png",
                size_hint=(None, None),
                size=(55, 55))
        anchor_layout = AnchorLayout(anchor_x='right', anchor_y='top', size_hint_y=None, height=690)
        anchor_layout.add_widget(image)
...
class MatematicaCriarScreen(Screen):
    def __init__(self, **kwargs):
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Matematica\MatiCriar.png",
                size_hint=(None, None),
                size=(260, 260))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=290)
        anchor_layout.add_widget(image)
...
class MatematicaEscolherScreen(Screen):
    def __init__(self, **kwargs):
       ...
       # Botões "Escolher"
        brn1 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/+-/adicao.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn2 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/×÷/multiplicacao.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn3 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/×÷/divisao.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), 
        ...
        btn4 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/+-/subtracao.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
...
class PalavraCruzadaScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem de fundo
        background_image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Pc-Imprimir\Fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Pc-Imprimir\Pc-imagem.png",
                size_hint=(None, None),
                size=(55, 55))
        anchor_layout = AnchorLayout(anchor_x='right', anchor_y='top', size_hint_y=None, height=690)
        anchor_layout.add_widget(image)
...
class PalavraCruzadaCriarScreen(Screen):
    def __init__(self, **kwargs):
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\Pc-Imprimir\Pc.png",
                size_hint=(None, None),
                size=(260, 260))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=290)
        anchor_layout.add_widget(image)
...
class PalavraCruzadaEscolherScreen(Screen):
    def __init__(self, **kwargs):
       ...
       # Botões "Escolher"
        brn1 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/facil1.jpg", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn2 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/medio1.jpg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn3 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/dificil1.jpg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), 
        ...
        btn4 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/facil2.jpg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        btn5 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/medio2.jpg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        btn6 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/pc/dificil2.jpg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), 
...
class PinturaScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Imagem de fundo
        background_image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\pintura/fundo.png", allow_stretch=True, keep_ratio=False)
        layout.add_widget(background_image)
        ...
        # Imagem no canto superior direito
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\pintura\pinturap.png",
                size_hint=(None, None),
                size=(55, 55))
        anchor_layout = AnchorLayout(anchor_x='right', anchor_y='top', size_hint_y=None, height=690)
        anchor_layout.add_widget(image)
...
class PinturaCriarScreen(Screen):
    def __init__(self, **kwargs):
        ...
        image = Image(source="TCC/py.kivy/py/img_wireframe\ICONS\pintura/pintura.png",
                size_hint=(None, None),
                size=(260, 260))
        anchor_layout = AnchorLayout(anchor_x='center', anchor_y='center', size_hint_y=None, height=290)
        anchor_layout.add_widget(image)
...
# Botões "Escolher"
        brn1 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/P_animais/animal1.jpeg", 
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0),
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn2 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/P_alimentos/alimento1.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        brn3 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/Cores/cores1.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), 
        ...
        btn4 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/P_animais/animal2.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        btn5 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/P_alimentos/alimento2.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), #tamanho
        ...
        btn6 = Button(text="", 
              background_normal="TCC/py.kivy/py/img_wireframe/conteudo_img/Cores/cores2.jpeg",
              background_down="TCC/py.kivy/py/img_wireframe/transparent.png",
              border=(0,0,0,0), 
              size_hint=(None, None), 
              size=(115, 160), 
